...
def init_extract_params(input_file, extraction_type, reverse, max_iter):
...
def sss_command(extraction_type, method, reverse, evaluation_data, max_iter, input_file, output_file):
    extract_parameters = init_extract_params(input_file, extraction_type, reverse, max_iter)
